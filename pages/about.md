...
<div class="row">
## 🧠 Programming Skills
{% include skills.html title="Programming Skills" source=site.data.programming %}
## 🔬 Domain Tools / Bioinformatics
{% include skills.html title="Domain Tools & Libraries" source=site.data.non-programming %}
</div>
